    ...
    <div>
      <div className="form">
        <input
          ...
          value={note}
          className="border-2 border-amber-200 bg-amber-300 shadow-sm  hover:scale-110 duration-300"
        />
        <svg
          className="w-6 h-6 ms-3 cursor-pointer hover:scale-110 duration-300 "
          ...
          return (
            <div className="result" key={addto.id}>
              ...
              >
                <div
                  id="card"
                  className="border-3 rounded-lg border-amber-400 shadow-md hover:shadow-lg hover:shadow-amber-200 "
                >
